...
public class AdminService {
    ...
    private final PollVoteRepository pollVotes;
    ...
    public AdminService(UserRepository users, UserFavoriteRepository favorites,
                        ...
                        PlaceRepository places, PollVoteRepository pollVotes, MeterRegistry registry) {
        this.users = users;
    ...
    public AdminStatsResponse stats() {
        ...
        long uptimeSeconds = uptime != null ? Math.round(uptime.value()) : 0;
        ...
        return new AdminStatsResponse(
                ...
                pushSubs.count(), places.countDistinctPlaces(),
                sharedLists.countByKind("poll"), pollVotes.count(),
                http, google, uptimeSeconds, topSearches);
    }
}
