export const translations = {
    en: {
        ...
        'admin.polls': 'Polls',
        'admin.poll_votes': 'Poll votes',
        'admin.uptime': 'Uptime',
        'admin.engagement': 'Engagement',
        'admin.system': 'System',
        'admin.actions': 'Actions',
        'admin.gen_poll': 'Generate this week’s poll',
        'admin.gen_busy': 'Generating…',
        'admin.featured_now': 'Live poll of the week',
        'admin.no_featured': 'No poll of the week yet — generate one.',
        'admin.open': 'Open',
        ...
        'featured.title': 'This week’s poll',
        'featured.vote': 'Vote now',
        ...
        'compare.poll': 'Make it a poll',
        'poll.default_name': 'Where should we go?',
        'poll.copied': 'Poll link copied!',
        'poll.subtitle': 'Tap to vote — no login needed.',
        'poll.vote': 'Vote',
        'poll.voted': 'Your vote',
        'poll.votes': 'votes',
        'poll.total': 'total votes',
        'poll.leading': 'Leading',
        'poll.notfound': 'This poll isn’t available anymore.',
        'poll.make_own_title': 'Deciding with your own group?',
        'poll.make_own_desc': 'Search, pick 2–3 spots, and share a poll — no login, takes a minute.',
        'poll.make_own': 'Make your own poll',
        'poll.voted_thanks': 'Vote counted!',
        'loc.near': 'Near',
        ...
        'about.star_note': 'NearPoint is open source. If you like it, a ⭐ genuinely helps.',
    ...
    tr: {
        ...
        'admin.polls': 'Anketler',
        'admin.poll_votes': 'Anket oyları',
        'admin.uptime': 'Çalışma süresi',
        'admin.engagement': 'Etkileşim',
        'admin.system': 'Sistem',
        'admin.actions': 'İşlemler',
        'admin.gen_poll': 'Bu haftanın anketini üret',
        'admin.gen_busy': 'Üretiliyor…',
        'admin.featured_now': 'Haftanın canlı anketi',
        'admin.no_featured': 'Henüz haftanın anketi yok — bir tane üret.',
        'admin.open': 'Aç',
        'admin.updated': 'Az önce güncellendi',
        ...
        'compare.poll': 'Anket yap',
        'poll.default_name': 'Nereye gidelim?',
        'poll.copied': 'Anket linki kopyalandı!',
        'poll.subtitle': 'Dokun ve oy ver — giriş gerekmez.',
        'poll.vote': 'Oy ver',
        'poll.voted': 'Oyun',
        'poll.votes': 'oy',
        'poll.total': 'toplam oy',
        'poll.leading': 'Önde',
        'poll.notfound': 'Bu anket artık mevcut değil.',
        'poll.make_own_title': 'Kendi grubunla mı karar veriyorsun?',
        'poll.make_own_desc': 'Ara, 2–3 yer seç ve anket paylaş — giriş yok, bir dakika sürer.',
        'poll.make_own': 'Kendi anketini yap',
        'poll.voted_thanks': 'Oyun sayıldı!',
        'loc.near': 'Konum:',
        ...
        'passport.level': 'Seviye',
        'passport.to_next': 'kaldı:',
        'passport.max': 'En üst seviyedesin!',
        'level.newcomer': 'Yeni Kaşif',
        'level.explorer': 'Kaşif',
        'level.adventurer': 'Maceracı',
        'level.pathfinder': 'İz Sürücü',
        'level.legend': 'Yerel Efsane',
        ...
        'about.star': 'GitHub’da yıldızla',
        'about.star_note': 'NearPoint açık kaynak. Beğendiysen bir ⭐ gerçekten çok yardımcı olur.',
